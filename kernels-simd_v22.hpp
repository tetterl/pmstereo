...
/**
 * Based on simd_v17
 * Replace loadu2_128 with loadu_ps to load left and right channels in the same operation
 */
...
float mcost(KernelView& wv, KernelView& ov, float* fp, int x, int y, int rows, int cols, int sign,
  ...
  for(int qy = qy_start; qy <= qy_end; ++qy){
    ...
    for(int qx = qx_start; qx <= qx_end; qx += 8){
      ...
      __m256 RGBA0_RGBA1_left_f =  _mm256_insertf128_ps(RGBA0L_RGBA0R_f, _mm256_extractf128_ps(RGBA1L_RGBA1R_f,0), 1);
      __m256 RGBA2_RGBA3_left_f =  _mm256_insertf128_ps(RGBA2L_RGBA2R_f, _mm256_extractf128_ps(RGBA3L_RGBA3R_f,0), 1);
      __m256 RGBA0_RGBA1_right_f = _mm256_insertf128_ps(RGBA1L_RGBA1R_f, _mm256_extractf128_ps(RGBA0L_RGBA0R_f,1), 0);
      __m256 RGBA2_RGBA3_right_f = _mm256_insertf128_ps(RGBA3L_RGBA3R_f, _mm256_extractf128_ps(RGBA2L_RGBA2R_f,1), 0);
      ...
      __m256 RGBA4_RGBA5_left_f  = _mm256_insertf128_ps(RGBA4L_RGBA4R_f, _mm256_extractf128_ps(RGBA5L_RGBA5R_f,0), 1);
      __m256 RGBA6_RGBA7_left_f  = _mm256_insertf128_ps(RGBA6L_RGBA6R_f, _mm256_extractf128_ps(RGBA7L_RGBA7R_f,0), 1);
      __m256 RGBA4_RGBA5_right_f = _mm256_insertf128_ps(RGBA5L_RGBA5R_f, _mm256_extractf128_ps(RGBA4L_RGBA4R_f,1), 0);
      __m256 RGBA6_RGBA7_right_f = _mm256_insertf128_ps(RGBA7L_RGBA7R_f, _mm256_extractf128_ps(RGBA6L_RGBA6R_f,1), 0);
