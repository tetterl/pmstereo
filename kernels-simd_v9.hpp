...
struct KernelView{
  ...
  // row order and channels interleaved (R1G1B1,R2G2B2, ...)
  uint8_t* i;
  // Gradient
  float* g;
  // Planes (format: ABC)
...
float mcost(KernelView& wv, KernelView& ov, float* fp, int x, int y, int rows, int cols, int sign,
  ...
  __m256i threesi = _mm256_set1_epi32(3);
  ...
  __m128i rgba_perm1 = _mm_setr_epi8(0,1,2,0x80, 4,5,6,0x80, 8,9,10,0x80, 12,13,14,0x80);
  // https://stackoverflow.com/questions/2973708/fast-24-bit-array-32-bit-array-conversion
  __m128i rgba_perm2 = _mm_setr_epi8(0,1,2,0x80, 3,4,5,0x80, 6,7,8,0x80, 9,10,11,0x80);
  ...
  for(int qy = qy_start; qy <= qy_end; ++qy){
    ...
    for(int qx = qx_start; qx <= qx_end; qx += 8){
      ...
      ///
      // pixel 0-3
      __m128i qdx_p0_3 = _mm256_castsi256_si128(qdx); // extract (by casting)lower 128 lane
      __m128i idx_p0_3_left = _mm_add_epi32(_mm256_castsi256_si128(qdycols), qdx_p0_3);
      __m128i idx_p0_3_left_scale = _mm_add_epi32(idx_p0_3_left, _mm_add_epi32(idx_p0_3_left, idx_p0_3_left));
      __m128i idx_p0_3_right_scale = _mm_add_epi32(idx_p0_3_left_scale, _mm256_castsi256_si128(threesi));
      // [R0,G0,B0,A0, R1,G1,B1,A1, R2,G2,B2,A2, R3,G3,B3,A3]
      // left: left matching point for weighting
      __m128i RGB0_RGB1_RGB2_RGB3_XXXX_left = _mm_i32gather_epi32(reinterpret_cast<const int*>(ov.i), idx_p0_3_left_scale, 1);
      __m128i RGBA0_RGBA1_RGBA2_RGBA3_left = _mm_shuffle_epi8(RGB0_RGB1_RGB2_RGB3_XXXX_left, rgba_perm1);  // insert alpha channel
      __m256i RGBA0_RGBA1_left = _mm256_cvtepu8_epi32(RGBA0_RGBA1_RGBA2_RGBA3_left); // convert uint8 to int32 (lower 128 lane)
      __m128i RGBA2_RGBA3_RGBA0_RGBA1_left = _mm_shuffle_epi32(RGBA0_RGBA1_RGBA2_RGBA3_left, _MM_SHUFFLE(1, 0, 3, 2));
      __m256i RGBA2_RGBA3_left = _mm256_cvtepu8_epi32(RGBA2_RGBA3_RGBA0_RGBA1_left); // convert uint8 to int32 (lower 128 lane)
      ...
      __m128i RGB0_RGB1_RGB2_RGB3_XXXX_right = _mm_i32gather_epi32(reinterpret_cast<const int*>(ov.i), idx_p0_3_right_scale, 1);
      __m128i RGBA0_RGBA1_RGBA2_RGBA3_right = _mm_shuffle_epi8(RGB0_RGB1_RGB2_RGB3_XXXX_right, rgba_perm1);  // insert alpha channel
      __m256i RGBA0_RGBA1_right = _mm256_cvtepu8_epi32(RGBA0_RGBA1_RGBA2_RGBA3_right); // convert uint8 to int32 (lower 128 lane)
      __m128i RGBA2_RGB3_RGBA0_RGBA1_right = _mm_shuffle_epi32(RGBA0_RGBA1_RGBA2_RGBA3_right, _MM_SHUFFLE(1, 0, 3, 2));
      ...
      // work view
      __m128i RGB0_RGB1_RGB2_RGB3_XXXX_wv = _mm_loadu_si128(reinterpret_cast<const __m128i*>(wv.i + qy*cols*3 + qx*3)); // unaligned load needed
      __m128i RGBA0_RGBA1_RGBA2_RGBA3_wv = _mm_shuffle_epi8(RGB0_RGB1_RGB2_RGB3_XXXX_wv, rgba_perm2);  // insert alpha channel
      __m256i RGBA0_RGBA1_wv = _mm256_cvtepu8_epi32(RGBA0_RGBA1_RGBA2_RGBA3_wv); // convert uint8 to int32
      __m128i RGBA2_RGB3_RGBA0_RGBA1_wv = _mm_shuffle_epi32(RGBA0_RGBA1_RGBA2_RGBA3_wv, _MM_SHUFFLE(1, 0, 3, 2));
      ...
      __m128i idx_p4_7_left = _mm_add_epi32(_mm256_castsi256_si128(qdycols), qdx_p4_7);
      __m128i idx_p4_7_left_scale = _mm_add_epi32(idx_p4_7_left, _mm_add_epi32(idx_p4_7_left, idx_p4_7_left));
      __m128i idx_p4_7_right_scale = _mm_add_epi32(idx_p4_7_left_scale, _mm256_castsi256_si128(threesi));  // omit multiplication by four since we have scale

      // [R4,G4,B4,A4, R5,G5,B5,A5, R6,G6,B6,A6, R7,G7,B7,A7]
      // left: left matching point for weighting
      __m128i RGB4_RGB5_RGB6_RGB7_left = _mm_i32gather_epi32(reinterpret_cast<const int*>(ov.i), idx_p4_7_left_scale, 1);
      __m128i RGBA4_RGBA5_RGBA6_RGBA7_left = _mm_shuffle_epi8(RGB4_RGB5_RGB6_RGB7_left, rgba_perm1);  // insert alpha channel
      __m256i RGBA4_RGBA5_left = _mm256_cvtepu8_epi32(RGBA4_RGBA5_RGBA6_RGBA7_left); // convert uint8 to int32 (lower 128 lane)
      __m128i RGBA6_RGB7_RGBA4_RGBA5_left = _mm_shuffle_epi32(RGBA4_RGBA5_RGBA6_RGBA7_left, _MM_SHUFFLE(1, 0, 3, 2));
      ...
      // right: right matching point for weighting
      __m128i RGB4_RGB5_RGB6_RGB7_XXXX_right = _mm_i32gather_epi32(reinterpret_cast<const int*>(ov.i), idx_p4_7_right_scale, 1);
      __m128i RGBA4_RGBA5_RGBA6_RGBA7_right = _mm_shuffle_epi8(RGB4_RGB5_RGB6_RGB7_XXXX_right, rgba_perm1);  // insert alpha channel
      __m256i RGBA4_RGBA5_right = _mm256_cvtepu8_epi32(RGBA4_RGBA5_RGBA6_RGBA7_right); // convert uint8 to int32 (lower 128 lane)
      __m128i RGBA6_RGB7_RGBA4_RGBA5_right = _mm_shuffle_epi32(RGBA4_RGBA5_RGBA6_RGBA7_right, _MM_SHUFFLE(1, 0, 3, 2));
      ...
      // work view
      __m128i RGBA4_RGBA5_RGBA6_RGB7_XXXX_wv = _mm_loadu_si128(reinterpret_cast<const __m128i*>(wv.i + qy*cols*3 + qx*3 + 12)); // unaligned load needed
      __m128i RGBA4_RGBA5_RGBA6_RGBA7_wv = _mm_shuffle_epi8(RGBA4_RGBA5_RGBA6_RGB7_XXXX_wv, rgba_perm2);  // insert alpha channel
      __m256i RGBA4_RGBA5_wv = _mm256_cvtepu8_epi32(RGBA4_RGBA5_RGBA6_RGBA7_wv); // convert uint8 to int32
      __m128i RGBA6_RGB7_RGBA4_RGBA5_wv = _mm_shuffle_epi32(RGBA4_RGBA5_RGBA6_RGBA7_wv, _MM_SHUFFLE(1, 0, 3, 2));
...
public:
  ...
  Kernel(const CommonView& v1, const CommonView& v2, int rows, int cols) : BaseKernel(rows, cols) {
    ...
    // Images
    v1_.i = static_cast<uint8_t *>(aligned_alloc(16,(rows*cols*3 + 24)*sizeof(uint8_t)));
    v2_.i = static_cast<uint8_t *>(aligned_alloc(16,(rows*cols*3 + 24)*sizeof(uint8_t)));
    for (int y = 0; y < rows; ++y) {
      for (int x = 0; x < cols; ++x) {
        v1_.i[y * cols * 3 + x * 3 + 0] = v1.i[y * cols * 3 + x * 3 + 0];
        v1_.i[y * cols * 3 + x * 3 + 1] = v1.i[y * cols * 3 + x * 3 + 1];
        v1_.i[y * cols * 3 + x * 3 + 2] = v1.i[y * cols * 3 + x * 3 + 2];
      }
    }
    for (int y = 0; y < rows; ++y) {
      for (int x = 0; x < cols; ++x) {
        v2_.i[y * cols * 3 + x * 3 + 0] = v2.i[y * cols * 3 + x * 3 + 0];
        v2_.i[y * cols * 3 + x * 3 + 1] = v2.i[y * cols * 3 + x * 3 + 1];
        v2_.i[y * cols * 3 + x * 3 + 2] = v2.i[y * cols * 3 + x * 3 + 2];
      }
    }
    // Gradients
