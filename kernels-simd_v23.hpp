...
/**
 * Based on simd_v22
 * improved version with less latency
 */
...
float mcost(KernelView& wv, KernelView& ov, float* fp, int x, int y, int rows, int cols, int sign,
  ...
  for(int qy = qy_start; qy <= qy_end; ++qy){
    ...
    for(int qx = qx_start; qx <= qx_end; qx += 8){
      ...
      __m256 RGBA0L_RGBA0R_f = _mm256_loadu_ps(ov.i_f + idx_left_tmp[0]);
      __m256 RGBA1L_RGBA1R_f = _mm256_loadu_ps(ov.i_f + idx_left_tmp[1]);
      __m256 RGBA0R_RGBA1L_f = _mm256_permute2f128_ps(RGBA0L_RGBA0R_f, RGBA1L_RGBA1R_f, 0b00100001);
      __m256 RGBA2L_RGBA2R_f = _mm256_loadu_ps(ov.i_f + idx_left_tmp[2]);
      __m256 RGBA3L_RGBA3R_f = _mm256_loadu_ps(ov.i_f + idx_left_tmp[3]);
      __m256 RGBA2R_RGBA3L_f = _mm256_permute2f128_ps(RGBA2L_RGBA2R_f, RGBA3L_RGBA3R_f, 0b00100001);

      __m256 RGBA0_RGBA1_right_f = _mm256_blend_ps(RGBA0R_RGBA1L_f, RGBA1L_RGBA1R_f, 0b11110000);
      __m256 RGBA0_RGBA1_left_f = _mm256_blend_ps(RGBA0L_RGBA0R_f, RGBA0R_RGBA1L_f, 0b11110000);
      __m256 RGBA2_RGBA3_right_f = _mm256_blend_ps(RGBA2R_RGBA3L_f, RGBA3L_RGBA3R_f, 0b11110000);
      __m256 RGBA2_RGBA3_left_f = _mm256_blend_ps(RGBA2L_RGBA2R_f, RGBA2R_RGBA3L_f, 0b11110000);
      ...
      // left: left matching point for weighting
      // right: right matching point for weighting
      __m256 RGBA4L_RGBA4R_f = _mm256_loadu_ps(ov.i_f + idx_left_tmp[4]);
      __m256 RGBA5L_RGBA5R_f = _mm256_loadu_ps(ov.i_f + idx_left_tmp[5]);
      __m256 RGBA4R_RGBA5L_f = _mm256_permute2f128_ps(RGBA4L_RGBA4R_f, RGBA5L_RGBA5R_f, 0b00100001);
      __m256 RGBA6L_RGBA6R_f = _mm256_loadu_ps(ov.i_f + idx_left_tmp[6]);
      __m256 RGBA7L_RGBA7R_f = _mm256_loadu_ps(ov.i_f + idx_left_tmp[7]);
      __m256 RGBA6R_RGBA7L_f = _mm256_permute2f128_ps(RGBA6L_RGBA6R_f, RGBA7L_RGBA7R_f, 0b00100001);

      __m256 RGBA4_RGBA5_right_f = _mm256_blend_ps(RGBA4R_RGBA5L_f, RGBA5L_RGBA5R_f, 0b11110000);
      __m256 RGBA4_RGBA5_left_f = _mm256_blend_ps(RGBA4L_RGBA4R_f, RGBA4R_RGBA5L_f, 0b11110000);
      __m256 RGBA6_RGBA7_right_f = _mm256_blend_ps(RGBA6R_RGBA7L_f, RGBA7L_RGBA7R_f, 0b11110000);
      __m256 RGBA6_RGBA7_left_f = _mm256_blend_ps(RGBA6L_RGBA6R_f, RGBA6R_RGBA7L_f, 0b11110000);
